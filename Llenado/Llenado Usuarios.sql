...
INSERT INTO vpv_demographic_types (demographic_typeid, name) VALUES (1, 'Genero');
INSERT INTO vpv_demographic_types (demographic_typeid, name) VALUES (2, 'Nivel educativo');
INSERT INTO vpv_demographic_types (demographic_typeid, name) VALUES (3, 'Estado civil');
INSERT INTO vpv_demographic_types (demographic_typeid, name) VALUES (4, 'Religión');
INSERT INTO vpv_demographic_types (demographic_typeid, name) VALUES (5, 'Discapacidad');


-- Datos demográficos para 'Genero' 
INSERT INTO dbo.vpv_demographic_data (code, description, demographic_typeid) VALUES ('M', 'Masculino', 1);
INSERT INTO dbo.vpv_demographic_data (code, description, demographic_typeid) VALUES ('F', 'Femenino', 1);
INSERT INTO dbo.vpv_demographic_data (code, description, demographic_typeid) VALUES ('O', 'Otro', 1);

-- Datos demográficos para 'Nivel educativo'
INSERT INTO dbo.vpv_demographic_data (code, description, demographic_typeid) VALUES ('PRI', 'Primaria', 2);
INSERT INTO dbo.vpv_demographic_data (code, description, demographic_typeid) VALUES ('SEC', 'Secundaria', 2);
INSERT INTO dbo.vpv_demographic_data (code, description, demographic_typeid) VALUES ('UNI', 'Universidad', 2);

-- Datos demográficos para 'Estado civil'
INSERT INTO dbo.vpv_demographic_data (code, description, demographic_typeid) VALUES ('S', 'Soltero/a', 3);
INSERT INTO dbo.vpv_demographic_data (code, description, demographic_typeid) VALUES ('C', 'Casado/a', 3);
INSERT INTO dbo.vpv_demographic_data (code, description, demographic_typeid) VALUES ('D', 'Divorciado/a', 3);

-- Datos demográficos para 'Religión'
INSERT INTO dbo.vpv_demographic_data (code, description, demographic_typeid) VALUES ('CAT', 'Católica', 4);
INSERT INTO dbo.vpv_demographic_data (code, description, demographic_typeid) VALUES ('PRO', 'Protestante', 4);
INSERT INTO dbo.vpv_demographic_data (code, description, demographic_typeid) VALUES ('SIN', 'Sin religión', 4);

-- Datos demográficos para 'Condición de discapacidad'
INSERT INTO dbo.vpv_demographic_data (code, description, demographic_typeid) VALUES ('ND', 'Sin Discapacidad', 5);
INSERT INTO dbo.vpv_demographic_data (code, description, demographic_typeid) VALUES ('VI', 'Visual', 5);
INSERT INTO dbo.vpv_demographic_data (code, description, demographic_typeid) VALUES ('AU', 'Auditiva', 5);
