...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Tabla temporal para documentos digitales
        ...
        -- Insertar documentos si no existen
        ...
        -- Insertar versión (checksum después)
        ...
        -- Calcular hash (checksum de datos clave)
